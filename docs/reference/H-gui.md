...
4. **Aplikace DSP parametrů** — `ch.stage(0..2).set(i, v)` a `setEnabled(bool)` pro AGC (3 params), ENHANCER (3 params: process/contour/mid), LIMITER (2 params). Pořadí odpovídá indexům v `Param` tabulkách stage.
